...
def oversample(X_train, y_train):
    ...
    y_np = y_train.astype(str).to_numpy()
...
_phase2_explainer = shap.Explainer(model.predict_proba, _phase2_background)
_phase2_shap = _phase2_explainer(_phase2_X)
_phase2_classes = [str(x) for x in model.classes_]
_phase2_plot_global_shap(
    _phase2_shap,
    _phase2_X,
    _phase2_classes,
    'SVM_Shap_Global_Feature_Importance.png',
    'SVM_Shap_Global_Feature_Importance.csv',
    'SVM - Global SHAP Feature Importance'
)
